<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MultiselectDropDown.ascx.cs" Inherits="TeaHousePeople.Samples.Web.Controls.MultiselectDropDown" %>
<asp:Table ID="ContainerTable" runat="server" BorderColor="#7F9DB9" BackColor="White" BorderWidth="1" CellPadding="0" CellSpacing="0">
    <asp:TableRow Height="18">
        ...
        </asp:TableCell><asp:TableCell CssClass="dropImageCell">
            <asp:Image ID="DropImage" runat="server" ImageUrl="../SysImages/down.png" />
        ...
        </asp:TableCell></asp:TableRow></asp:Table><script language="javascript" type="text/javascript">
...
</script><asp:Label ID="ClientScriptLabel" runat="server" />