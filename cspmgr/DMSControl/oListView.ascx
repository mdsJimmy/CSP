<%@ Control Language="C#" AutoEventWireup="true" CodeFile="oListView.ascx.cs" Inherits="oListView" %>
                    ...
                    <Fields>
                        <asp:TemplatePagerField OnPagerCommand="TemplatePagerField_OnPagerCommand">
                            <PagerTemplate>
                                ...
                                <asp:DropDownList ID="Jumper" runat="server" AutoPostBack="True" OnSelectedIndexChanged="Jumper_SelectedIndexChanged" Enabled="False"></asp:DropDownList>
...
<script type ="text/javascript">
    ...
    if ('<%:PageCount%>' == '0'&& document.getElementById("FirstPageButton")!=null) { 
