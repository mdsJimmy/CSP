...
public partial class oListView : System.Web.UI.UserControl
{
    ...
    List<Collumn> ListViewCollumns = new List<Collumn>(); //欄位清單

    int TotalRowCount = 0; //總筆數;
    
    int iPageSize = 0; //每頁size;
    int iPageCount = 0; //總頁數;
    protected int PageCount = 0;//給前端網頁使用判斷 上下頁首尾頁 是否無效
    ...
    private void init_ListView()
    {
        ...
        //產生ListView的Template
        _ListView.LayoutTemplate = new CreateTemplate(myListItemType.Header, ListViewCollumns, DataKeyNames, IsUseCheckBox, OnClickExecFunc, TRTitle, IsUseBorder);
        _ListView.ItemTemplate = new CreateTemplate(myListItemType.Item, ListViewCollumns, DataKeyNames, IsUseCheckBox, OnClickExecFunc, TRTitle, IsUseBorder);
        _ListView.AlternatingItemTemplate = new CreateTemplate(myListItemType.AlternatingItem, ListViewCollumns, DataKeyNames, IsUseCheckBox, OnClickExecFunc, TRTitle, IsUseBorder);
        _ListView.EmptyDataTemplate = new CreateTemplate(myListItemType.EmptyData, ListViewCollumns, DataKeyNames, IsUseCheckBox, OnClickExecFunc, TRTitle, IsUseBorder);
...
public class CreateTemplate : System.Web.UI.ITemplate
{
    //System.Web.UI.WebControls.ListItemType templateType;
    myListItemType templateType;
    List<Collumn> ListViewCollumns = new List<Collumn>();
    ...
    public CreateTemplate(myListItemType type, object o, string sDataKeyNames, bool bIsUseCheckBox, string sOnClickExecFunc, string sTRTitle, bool bIsUseBorder)
    {
        templateType = type;
        ListViewCollumns = (List<Collumn>)o;
    ...
    public void InstantiateIn(System.Web.UI.Control container)
    {
        ...
        switch (templateType)
        {
            ...
            case myListItemType.Item:
                ...
                break;
            case myListItemType.AlternatingItem:
                l_trID.ID = "_tr";
                ph.Controls.Add(new LiteralControl("<tr "));
                ph.Controls.Add(l_trID);
                if (TRTitle != "")
                ...
                ph.DataBinding += new EventHandler(Item_DataBinding);
                break;
            case myListItemType.Footer:
                 
                
 
                ph.Controls.Add(new LiteralControl("</table>"));
                break;
            case myListItemType.EmptyData:
