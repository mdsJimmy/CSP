<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/MainPage.master" AutoEventWireup="true"
    CodeFile="MipInfoM.aspx.cs" Inherits="yuantalife_web_YL0010M" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div id="UserData-form" class="form-horizontal">
        <h4 class="header smaller lighter green">
            <i class="ace-icon fa fa-check-square-o bigger-110"></i><b>最新公告資料上稿-維護 </b>
        </h4>
        <%=ParseWording("A0008")%>
        <div class="space-6">
        </div>
        ...
        function DoCancel() {
            $.confirm({
                ...
                confirm: function () {
                    ...
                    parent.location.replace("MipInfoQ.aspx?a=a"+ unescape(decodeURI("<%=MDS.Utility.NUtility.UrlEncode(strQueryCondi)%>")));
                },
                cancel: function () {
                    //alert('Canceled!')
                }
