<%@ WebHandler Language="C#" Class="ImageFileProvider" %>
...
public class ImageFileProvider : IHttpHandler
{
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        try
        {
            ...
            else
            {
                ...
                context.Response.AddHeader("Content-Length", _voMIP_FILE_STORE.FILE_IMG.Length.ToString());
