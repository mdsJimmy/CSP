...
{
    public partial class MobileDeviceDataPublic 
    {
        ...
        public void Insert(System.Data.SqlClient.SqlConnection connection)
        {
            using (System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand())
            {
                ...
                cmd.CommandText = "INSERT INTO MobileDeviceDataPublic (appname, AccountID, deviceid, pushid, phonetype, status, createdatetime) VALUES (@appname_PARAMS, @AccountID_PARAMS, @deviceid_PARAMS, @pushid_PARAMS, @phonetype_PARAMS, @status_PARAMS, @createdatetime_PARAMS)";
        ...
        public void Update(System.Data.SqlClient.SqlConnection connection)
        {
            ...
            {
                cmd.Connection = connection;
                cmd.CommandText = "UPDATE MobileDeviceDataPublic SET appname=@appname_PARAMS, AccountID=@AccountID_PARAMS, deviceid=@deviceid_PARAMS, pushid=@pushid_PARAMS, phonetype=@phonetype_PARAMS, status=@status_PARAMS, createdatetime=@createdatetime_PARAMS WHERE ";
                                cmd.Parameters.AddWithValue("@appname_PARAM", _appname);
                cmd.Parameters.AddWithValue("@AccountID_PARAM", _accountID);
                cmd.Parameters.AddWithValue("@deviceid_PARAM", _deviceid);
                cmd.Parameters.AddWithValue("@pushid_PARAM", _pushid);
        ...
        private void Delete(System.Data.SqlClient.SqlConnection connection)
        {
            ...
            {
                cmd.Connection = connection;
                cmd.CommandText = "DELETE FROM MobileDeviceDataPublic WHERE ";
