    ...
    public partial class MIP_KV 
    {
        ...
        public void Insert(System.Data.SqlClient.SqlConnection connection)
        {
            using (System.Data.SqlClient.SqlCommand cmd = new System.Data.SqlClient.SqlCommand())
            {
                ...
                cmd.CommandText = "INSERT INTO MIP_KV (CKEY, CVALUE, CNOTE, CSTATUS, APPLY4) VALUES (@CKEY_PARAMS, @CVALUE_PARAMS, @CNOTE_PARAMS, @CSTATUS_PARAMS, @APPLY4_PARAMS)";
        ...
        public void Load(System.Data.SqlClient.SqlConnection connection)
        {
            ...
            {
                cmd.Connection = connection;
                cmd.CommandText = "SELECT CKEY, CVALUE, CNOTE, CSTATUS, APPLY4 FROM MIP_KV WHERE CKEY=@CKEY_PARAM";
                                cmd.Parameters.AddWithValue("@CKEY_PARAM", _cKEY);
        ...
        public void Update(System.Data.SqlClient.SqlConnection connection)
        {
            ...
            {
                cmd.Connection = connection;
                cmd.CommandText = "UPDATE MIP_KV SET CKEY=@CKEY_PARAMS, CVALUE=@CVALUE_PARAMS, CNOTE=@CNOTE_PARAMS, CSTATUS=@CSTATUS_PARAMS, APPLY4=@APPLY4_PARAMS WHERE CKEY=@CKEY_PARAM";
                                cmd.Parameters.AddWithValue("@CKEY_PARAM", _cKEY);
                cmd.Parameters.AddWithValue("@CVALUE_PARAM", _cVALUE);
                cmd.Parameters.AddWithValue("@CNOTE_PARAM", _cNOTE);
                cmd.Parameters.AddWithValue("@CSTATUS_PARAM", _cSTATUS);
        ...
        private void Delete(System.Data.SqlClient.SqlConnection connection)
        {
            ...
            {
                cmd.Connection = connection;
                cmd.CommandText = "DELETE FROM MIP_KV WHERE CKEY=@CKEY_PARAM";
                cmd.Parameters.AddWithValue("@CKEY_PARAM", _cKEY);
