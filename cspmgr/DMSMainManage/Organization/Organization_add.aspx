<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/MasterPage/MainPage.master" CodeFile="Organization_add.aspx.cs" Inherits="DMSMainManage_Organization_Organization_add" %>
    ...
    <div id="UserData-form" class="form-horizontal">
         <h4 class="header smaller lighter green">
           ...
           <!--所屬群組-->
                 <div class="form-group">
                    <label class="control-label col-sm-2 title"   > <%=ParseWording("A0007")%><%=ParseWording("B0012")%>:</label>&nbsp;&nbsp;
                      <div class="col-sm-2">
                       ...
                       <input name='oParentGroupID_Sel'  id="oParentGroupID_Sel" type="text" value='<%:TargerGroupID %>'    />
                       <input name='oParentGroupID'  id="oParentGroupID" type="hidden" value='<%:TargerGroupID %>'  />
                 ...
                 <div class="form-group">
                  ...
                  <input name="oGroupID"  id="oGroupID" type="text"   />
                    </div>
               </div>
			    <!--名稱-->
                <div class="form-group">
                ...
                <input name='oGroupName'  id="oGroupName" type="text"    />
        ...
        <div class="form-group">
                    <label class="control-label col-sm-2 title"   > <%=ParseWording("A0019")%> :</label>&nbsp;&nbsp;
                      <div class="col-sm-2">
                        <input name='oTEL'  id="oTEL" type="text"  />
	   ...
	   <!--地址-->
        <div class="form-group">
                ...
                <input name='oAddress'  id="oAddress" type="text"  />
                    </div>
               </div>
	     <!--備註-->
   <div class="form-group">
...
<script type="text/javascript">
    ...
    function DoSave() {
     ...
     PageMethods.AddProcess($("#oParentGroupID_Sel").val()
            , $("#oParentGroupID").val()
            , $("#oGroupID").val()
            , $("#oGroupName").val()
            , $("#oTEL").val()
            ...
            rules: {
                ...
                oGroupID: {
                    ...
                    remote:function () {
                        var r = {
                            type: "POST",
                            url: 'Organization_add.aspx/CheckGroupID',
                            contentType: "application/json; charset=utf-8",
                            dataType: "json",
                            data: JSON.stringify({
                             'ParentGroupID': '<%=MDS.Utility.NUtility.checkNull(Session["ParentGroupID"])%>',
                             'validateId': "",'validateValue': $('#oGroupID').val(),'validateError': "" }),
                            dataFilter: function (data) {
                                //alert('dataFilter>' + data);
                                var json = JSON.parse(data);
                                if (json.d == "True") {
