...
public partial class DMSMainManage_Organization_Organization_Main : BasePage
{
    string myGroupID = "";
    ...
    protected string tagUrl = "Organization_List.aspx";
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!string.IsNullOrEmpty(Request.QueryString["StrSearch"]))
            mySearch = Request.QueryString["StrSearch"];
        if (!string.IsNullOrEmpty(Request.QueryString["tagUrl"]))
            tagUrl = Request.QueryString["tagUrl"];
